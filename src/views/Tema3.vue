...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-3.col-md-6.col-sm-5.mb-md-4.md-mb-sm-4
        figure
    ...
    .tarjeta--BG06.p-4.px-lg-5.mb-4
      .tarjeta.tarjeta--BG07.p-4.mb-5
        PasosB.color-acento-botones
          ...
          .row(titulo="")
            .col-md-6.mb-4.mb-md-0
              h4 Implementación de pipelines de datos
              p Un pipeline es una serie de componentes encadenados para limpiar, transformar, almacenar y aplicar algoritmos de inteligencia artificial a los datos. Un ejemplo es el pipeline de Scikit-learn, herramienta que permite estructurar un flujo de trabajo completo, automatizando desde la transformación de datos hasta la predicción, garantizando así la coherencia entre el entrenamiento y la inferencia.
            .col-md-6
              figure
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        p En síntesis, la automatización eficaz de la gestión de datos requiere planificación estratégica, el diseño de pipelines robustos, la adopción de estándares de calidad y gobernanza, y el uso de herramientas adecuadas que se ajusten a las características del proyecto y los tipos de datos involucrados.
